 ...
 */
 ...
 $footer_wrapper_class = $footer_fixed_class = $link_hover_effect = $footer_active_widgets = $allowed_tags = '';

 $kd_allowed_tags = array(
		'a' => array(
			'class' => array(),
			'href'  => array(),
			'rel'   => array(),
    ...
    <div class="container">
       <span>
         <?php if (isset($redux_ThemeTek['tek-footer-text'])) {
           echo wp_kses( $redux_ThemeTek['tek-footer-text'], $kd_allowed_tags );
         } else {
