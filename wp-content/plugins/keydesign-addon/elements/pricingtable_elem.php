            ...
            $output = '<div class="pricing-wrapper">
                ...
                <div class="pricing-img">'.$content_icon.'</div>
                      ...
                      if ($pricing_currency_position == "currency-position-left") {
      				          $output .= '<span class="pricing-price default-plan"><span class="currency">'.$currency_symbol.'</span>'.$pricing_price.'</span>';
                        if ( '' != $secondary_plan_value ) {
                          $output .= '<span class="pricing-price secondary-plan"><span class="currency">'.$currency_symbol.'</span>'.$secondary_plan_value.'</span>';
                        }
                      } elseif ($pricing_currency_position == "currency-position-right") {
                        $output .= '<span class="pricing-price default-plan">'.$pricing_price.'<span class="currency">'.$currency_symbol.'</span></span>';
                        if ('' != $secondary_plan_value ) {
                          $output .= '<span class="pricing-price secondary-plan">'.$secondary_plan_value.'<span class="currency">'.$currency_symbol.'</span></span>';
                        }
                      }
